   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_native_bridge_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_native_bridge_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "native_bridge"))
...
internal object UniffiLib {
    ...
    external fun ffi_native_bridge_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    external fun ffi_native_bridge_rustbuffer_free(`buf`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    external fun ffi_native_bridge_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    external fun ffi_native_bridge_rust_future_poll_u8(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_u8(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_u8(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    external fun ffi_native_bridge_rust_future_poll_i8(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_i8(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_i8(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Byte
    external fun ffi_native_bridge_rust_future_poll_u16(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_u16(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_u16(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    external fun ffi_native_bridge_rust_future_poll_i16(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_i16(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_i16(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Short
    external fun ffi_native_bridge_rust_future_poll_u32(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_u32(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_u32(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    external fun ffi_native_bridge_rust_future_poll_i32(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_i32(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_i32(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    external fun ffi_native_bridge_rust_future_poll_u64(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_u64(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_u64(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    external fun ffi_native_bridge_rust_future_poll_i64(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_i64(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_i64(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    external fun ffi_native_bridge_rust_future_poll_f32(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_f32(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_f32(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Float
    external fun ffi_native_bridge_rust_future_poll_f64(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_f64(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_f64(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Double
    external fun ffi_native_bridge_rust_future_poll_rust_buffer(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_rust_buffer(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_rust_buffer(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    external fun ffi_native_bridge_rust_future_poll_void(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_cancel_void(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_free_void(`handle`: Long,
    ): Unit
    external fun ffi_native_bridge_rust_future_complete_void(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_native_bridge_uniffi_contract_version()
